...
def focus_game_window():
    ...
    try:
        ...
        hwnd = getattr(focus_game_window, "_hwnd", None)
        ...
        if not hwnd:
            ...
            def _callback(h, _lparam):
                ...
                if name == WINDOW_NAME.lower():
                    return True
                if "codename" in name or "funkin" in name or "friday night" in name or "psych" in name:
                    found.append(h)
                return True
